...
pub(crate) fn resolve_exporter(exporter: &OtelExporter) -> OtelExporter {
    match exporter {
        // DISABLED: Internal deployment - Statsig exporter always disabled
        // to prevent data leakage to external endpoints
...
mod tests {
    ...
    #[test]
    fn statsig_exporter_is_always_disabled() {
        // DISABLED: Internal deployment - Statsig exporter always resolves to None
        assert!(matches!(
